...
function Dashboard({ onSelectTool, onSignOut, onLoadPlan, onLoadAssessment, isAdmin }) {
  const allTools = [
    ...
    { id:"proposal",      title:"Business Proposal Generator", description:"Generate comprehensive, branded business proposals tailored to client requirements and Avature solutions.",               icon:"📋", status:"live", color:"#2E6DB4", externalUrl:"https://avature-proposal-builder.vercel.app" },
